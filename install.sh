#!/usr/bin/env sh
# Universal installer for authmatrix. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/authmatrix.git"
echo "Installing authmatrix ..."
