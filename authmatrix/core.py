"""AUTHMATRIX core — Test an access-control matrix (role x endpoint) for IDOR/authz gaps."""
...
RULES = [
    ("AUT-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("AUT-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("AUT-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
